...
const getItemCount = (_data: unknown) => 4;
  ...
  <View>
    <TouchableOpacity style={styles.storyItem}>
      <Avatar
        ...
        rounded
        source={{
          uri: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ1YCGF23x9ZnsAPqbtwKehUwJVBypk4_Rfow&usqp=CAU",
        }}
      />
      <Text>{title}</Text>
    </TouchableOpacity>
        ...
        <View style={{ flexDirection: "row" }}>
          <TouchableOpacity onPress={messageHandler}>
            <View style={styles.iconContainer}>
              <IconOctions name="heart" size={wp("7%")} />
            </View>
          </TouchableOpacity>
          <TouchableOpacity onPress={messageHandler}>
            <View style={styles.iconContainer}>
              <IconFontisto name="messenger" size={wp("7%")} />
            </View>
          </TouchableOpacity>
        </View>
      </View>
