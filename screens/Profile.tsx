...
import { Input, Button, Box, Icon } from "native-base";
  ...
  return (
    <View>
      <View style={{ padding: 10, paddingTop: 50 }}>
        <Icon as={AntDesign} name="arrowleft" size="xl" />
      </View>
      ...
      >
        <Button
          variant="subtle"
          width={150}
          endIcon={<Icon as={AntDesign} name="down" size="sm" />}
        >
          Following
        </Button>
        <Button width={150}>Message</Button>
      </Box>
