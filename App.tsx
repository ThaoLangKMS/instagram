...
import ReelPage from "./screens/Reel";
    ...
    >
      <Tab.Screen
        ...
        options={{
          ...
          tabBarIcon: ({ color, size }) => (
            <IconFeather name="home" size={30} color={color} />
          ),
        }}
      />
      <Tab.Screen
      ...
      <Tab.Screen
        ...
        options={{
          tabBarLabel: "Create",
          tabBarIcon: ({ color, size }) => (
            <IconOctions name="diff-added" color={color} size={size} />
          ),
        }}
      />
      <Tab.Screen
        ...
        options={{
          tabBarLabel: "Reel",
          tabBarIcon: ({ color, size }) => (
            <IconFeather name="youtube" color={color} size={size} />
          ),
          tabBarBadge: 3,
        }}
      />
